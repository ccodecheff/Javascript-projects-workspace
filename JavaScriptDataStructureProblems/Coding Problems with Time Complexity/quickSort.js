// Program to sort elements by quick sort
function sort(arr) {
  ...
  // Best case: array are sorted randomly : O(n * log n)
  // avg case: O(n * log n)
  // worst case : O(n^2) // list is already sorted,  so smallerelementarr would be empty
  // There would be no division of list all the rest array would be transfered onto bigger list 
